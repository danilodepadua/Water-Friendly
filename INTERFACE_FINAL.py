...
class WaterFriendlyApp:
    ...
    def create_registration_page(self):
        ...
        frame_cadastro_inteiro = customtkinter.CTkFrame(
            master=self.root, width=800, height=605, fg_color=preto)
    ...
    def acessar_planta(self, Cultura, planta_nome):
        ...
        self.frame_planta = customtkinter.CTkFrame(
            root, width=800, height=605, fg_color=preto)
        ...
        l_agua_precisa.place(x=20, y=140)
        ...
        l_agua_precisa_2.place(x=230, y=140)
        ...
        plt.legend(labels, fontsize="27", loc="upper right")
        ax.axis('equal')
        ...
        relatorio_label.place(x=20, y=20)
        ...
        if response.status == 200:
            for x in range(0, 5):
                if 'rain' in previsao_data['list'][x]:
                    ...
                    quantidade_chuva_3h = chuva_3h   # Calcula a quantidade de chuva em 3 horas
    ...
    def show_irrigation_info(self, planta_nome, day_number, Cultura):
        ...
        if resultado is not None:
            ...
            if agua_economizada >= quantidade_agua_necessaria:
                agua_economizada = quantidade_agua_necessaria
                quantidade_agua_gasta = 0
                fig, ax = plt.subplots(figsize=(15, 15))
                labels = ['Água economizada', 'Água necessária']
                ax.pie([agua_economizada, quantidade_agua_gasta], autopct='%1.1f%%',
                       textprops={'fontsize': 30, 'color': 'white'}, colors=[azul, laranja])
                plt.legend(labels, fontsize="27", loc="upper right")
                ax.axis('equal')
                ...
                l_agua_gasta_2 = customtkinter.CTkLabel(master=self.frame_cor_fundo, text=f"{quantidade_agua_gasta:.2f} L", font=(
                    'Josefin Sans bold', 20), text_color=azul)
                l_agua_gasta_2.place(x=580, y=200)
            else:
                quantidade_agua_gasta = quantidade_agua_necessaria - agua_economizada
                quantidade_agua_necessaria = quantidade_agua_gasta + agua_economizada
                fig, ax = plt.subplots(figsize=(15, 15))
                labels = ['Água economizada', 'Água necessária']
                ax.pie([agua_economizada,  quantidade_agua_gasta], autopct='%1.1f%%',
                       textprops={'fontsize': 30, 'color': 'white'}, colors=[azul, laranja])
